...
MY_IPK="enigma2-plugin-extensions-freeserver_8.3.8_all.ipk"
MY_DEB="enigma2-plugin-extensions-freeserver_8.3.8_all.deb"
...
echo "**  https://www.tunisia-sat.com/forums/threads/3907887/   **"
echo "************************************************************"
echo ''
